        ...
        <section className="grid gap-4">
          ...
          <div className="rounded-[1.5rem] border border-dashed border-[var(--color-line)] bg-[var(--color-surface)] p-5">
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-[var(--color-muted)]">Pick a photo here and it will go straight into your media library. For news and blog posts it becomes the cover immediately, while Desk posts can lean on portrait-led cards instead.</p>
            </div>
      ...
      <div className="grid gap-6 xl:sticky xl:top-24 xl:self-start">
        ...
        <article className="overflow-hidden rounded-[2rem] border border-[var(--color-line)] bg-white shadow-[0_14px_40px_rgba(10,61,98,0.08)]">
          ...
          <div className="border-t border-[var(--color-line)] p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-[var(--color-muted)]">This is the main article visual for blog and news content.</p>
          </div>
        </article>
