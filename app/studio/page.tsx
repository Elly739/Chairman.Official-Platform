      ...
      <div className="mt-8 grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <article className="rounded-[2rem] bg-[linear-gradient(145deg,_#0a3d62,_#0d517f)] p-8 text-white shadow-[0_20px_60px_rgba(10,61,98,0.18)]">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link href="/studio/posts/new" className="rounded-full border border-white/16 bg-white/10 px-5 py-3 text-sm font-semibold text-white">
              Create new post
            </Link>
            <Link href="/studio/chairmans-desk/new" className="rounded-full border border-white/24 bg-white/5 px-5 py-3 text-sm font-semibold text-white">
        ...
        <article className="rounded-[2rem] border border-[var(--color-line)] bg-white p-8 shadow-[0_14px_40px_rgba(10,61,98,0.08)]">
          ...
          <div className="mt-6 grid gap-4">
            ...
            <Link href={getStudioProjectHref(nextProject.slug)} className="rounded-[1.3rem] bg-[var(--color-surface)] px-5 py-4 text-sm font-semibold text-[var(--color-brand)] transition hover:bg-[var(--color-soft)]">
              Open next project
            </Link>
            <Link href="/studio/audience" className="rounded-[1.3rem] bg-[var(--color-surface)] px-5 py-4 text-sm font-semibold text-[var(--color-brand)] transition hover:bg-[var(--color-soft)]">
              Check audience inbox
            </Link>
          </div>
