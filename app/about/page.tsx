        ...
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="section-copy">
              Chairman.Official is the public home of Elly Okello, bringing together official communication, strategic direction, thought leadership, and media-ready storytelling.
            </p>
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Link href="/vision" className="inline-flex items-center justify-center rounded-full bg-[var(--color-brand)] px-6 py-3 text-sm font-semibold text-white">
                Read the Vision
              </Link>
